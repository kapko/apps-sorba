(function (global, factory) {
    ...
    var ContactDetailComponent = /** @class */ (function () {
        function ContactDetailComponent(urlUtils, appService, contactRest, contactHelper, appProjectsService) {
            var _this = this;
            this.urlUtils = urlUtils;
            this.appService = appService;
            ...
            this.appProjectsQuery = appProjectsService.watch({
                domain: this.activeDomainName,
                page: this.page,
                perPage: this.itemsPerPage
            });
         ...
         * @return {?}
         */
        ContactDetailComponent.prototype.getActiveDomain = /**
         * @private
         * @return {?}
         */
            function () {
         ...
         */
             ...
             * @return {?}
             */function (contact) {
                    _this.getContact(contact.id, _this.activeDomainName);
                }));
            };
        /**
         * @private
