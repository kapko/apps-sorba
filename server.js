(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ionic-native/keyboard/ngx'), require('@ionic-native/keyboard/ngx/index'), require('@ionic-native/in-app-browser/ngx'), require('@ionic-native/in-app-browser/ngx/index'), require('immutability-helper'), require('@sorba-app/sorba-ui-components'), require('@angular/common'), require('@agm/core'), require('@angular/platform-browser'), require('@angular/router'), require('@angular/forms'), require('graphql-tag'), require('@ionic-native/document-viewer/ngx'), require('@ionic-native/file/ngx'), require('@ionic-native/file-opener/ngx'), require('@ionic/angular'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/scrolling'), require('@angular/core'), require('apollo-angular'), require('apollo-cache-inmemory')) :
    typeof define === 'function' && define.amd ? define('contacts', ['exports', ], factory) :
    (factory((global.contacts = {}),global.ngx,global.i1,global.ngx$1,global.i1$1,global.update,global.sorbaUiComponents,global.ng.common,global.core,global.ng.platformBrowser,global.ng.router,global.ng.forms,global.gql,global.ngx$2,global.ngx$3,global.ngx$4,global.i1$2,global.rxjs,global.rxjs.operators,global.ng.cdk.scrolling,global.ng.core,global.i1$3,global.apolloCacheInmemory));
}(this, (function (exports,ngx,i1,ngx$1,i1$1,update,sorbaUiComponents,common,core,platformBrowser,router,forms,gql,ngx$2,ngx$3,ngx$4,i1$2,rxjs,operators,scrolling,i0,i1$3,apolloCacheInmemory) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var KeyboardHelper = /** @class */ (function () {
        function KeyboardHelper(keyboard) {
            var _this = this;
        ...
        /** @nocollapse */ KeyboardHelper.ngInjectableDef = i0.defineInjectable({ factory: function KeyboardHelper_Factory() { return new KeyboardHelper(i0.inject(i1.Keyboard)); }, token: KeyboardHelper, providedIn: "root" });
    ...
    var ContactAppsGQL = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ ContactAppsGQL.ngInjectableDef = i0.defineInjectable({ factory: function ContactAppsGQL_Factory() { return new ContactAppsGQL(i0.inject(i1$3.Apollo)); }, token: ContactAppsGQL, providedIn: "root" });
    ...
    var LanguagesRest = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ LanguagesRest.ngInjectableDef = i0.defineInjectable({ factory: function LanguagesRest_Factory() { return new LanguagesRest(i0.inject(i1$3.Apollo)); }, token: LanguagesRest, providedIn: "root" });
    ...
    var ContactAppByIdGQL = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ ContactAppByIdGQL.ngInjectableDef = i0.defineInjectable({ factory: function ContactAppByIdGQL_Factory() { return new ContactAppByIdGQL(i0.inject(i1$3.Apollo)); }, token: ContactAppByIdGQL, providedIn: "root" });
    ...
    var AppProjectsGQL = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ AppProjectsGQL.ngInjectableDef = i0.defineInjectable({ factory: function AppProjectsGQL_Factory() { return new AppProjectsGQL(i0.inject(i1$3.Apollo)); }, token: AppProjectsGQL, providedIn: "root" });
    ...
    var ScrollerComponent = /** @class */ (function () {
        function ScrollerComponent(platform, contactHelper, keyboardHelper) {
            var _this = this;
         ...
         * @return {?}
         */
        ScrollerComponent.prototype.setHeightForScroll = /**
         * @private
         * @return {?}
         */
            function () {
                ...
                this.setHeightViewScroll(height - 220 + "px");
            };
        /**
         * @param {?} height
         * @return {?}
    ...
    var GraphQLModule = /** @class */ (function () {
        ...
        GraphQLModule.decorators = [
            { type: i0.NgModule, args: [{
                        exports: [i1$3.ApolloModule],
                        providers: [
                            {
                                provide: i1$3.APOLLO_OPTIONS,
