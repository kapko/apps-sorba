(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ContactsComponent = /** @class */ (function () {
        ...
        Object.defineProperty(ContactsComponent.prototype, "leftPanelHeight", {
            get: /**
             * @return {?}
             */ function () {
                return this.isMobile
                    ? this.mobileHeight
                    : this.desktopHeight && this.desktopHeight + "px";
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
             ...
             */function (contacts) {
                    ...
                    setTimeout(( /**
                     * @return {?}
                     */function () { return _this.getHeightOfRightBlock(); }));
                }));
            };
        /**
         * @param {?} menuItem
        ...
        ContactsComponent.propDecorators = {
            ...
            leftPanel: [{ type: i0.ViewChild, args: ['leftPanel',] }]
        };
    ...
    var FooterComponent = /** @class */ (function () {
        function FooterComponent(linkRedirect, contactsHelper, appService) {
            // this.getLanguages();
            var _this = this;
        ...
        //   this.languages$ = this.languageGql.watch()
        //     .valueChanges
        //     .pipe(pluck('data', 'languages'));
        // }
        // private getLanguages(): void {
        //   this.languages$ = this.languageGql.watch()
        //     .valueChanges
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    // import { GraphQLModule } from './contacts.graphql.module';
    /** @type {?} */
    var routes = [
        {
            path: '',
