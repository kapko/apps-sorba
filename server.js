(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ionic-native/in-app-browser/ngx'), require('@ionic-native/in-app-browser/ngx/index'), require('@sorba-app/sorba-ui-components'), require('@ionic/angular'), require('@angular/common'), require('@agm/core'), require('@angular/platform-browser'), require('@angular/router'), require('@angular/forms'), require('graphql-tag'), require('immutability-helper'), require('@ionic-native/document-viewer/ngx'), require('@ionic-native/file/ngx'), require('@ionic-native/file-opener/ngx'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/scrolling'), require('@angular/core'), require('apollo-angular'), require('apollo-cache-inmemory')) :
    typeof define === 'function' && define.amd ? define('contacts', ['exports', '@ionic-native/in-app-browser/ngx', '@ionic-native/in-app-browser/ngx/index', '@sorba-app/sorba-ui-components', '@ionic/angular', '@angular/common', '@agm/core', '@angular/platform-browser', '@angular/router', '@angular/forms', 'graphql-tag', 'immutability-helper', '@ionic-native/document-viewer/ngx', '@ionic-native/file/ngx', '@ionic-native/file-opener/ngx', 'rxjs', 'rxjs/operators', '@angular/cdk/scrolling', '@angular/core', 'apollo-angular', 'apollo-cache-inmemory'], factory) :
    (factory((global.contacts = {}),global.ngx,global.i1,global.sorbaUiComponents,global.i1$1,global.ng.common,global.core,global.ng.platformBrowser,global.ng.router,global.ng.forms,global.gql,global.update,global.ngx$1,global.ngx$2,global.ngx$3,global.rxjs,global.rxjs.operators,global.ng.cdk.scrolling,global.ng.core,global.i1$2,global.apolloCacheInmemory));
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ContactRest = /** @class */ (function (_super) {
        __extends(ContactRest, _super);
        function ContactRest() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.document = gql(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n    query contactGql($id: ID!, $domain: String!) {\n      contactAppById(domain: $domain, id: $id) {\n        business_number\n        mobile_number\n        first_name\n        private_number\n        fax\n        website\n        address\n        logical20\n        name\n        id\n        postal_code\n        city\n        po_box\n        geocode_address {\n          lat\n          lon\n        }\n      }\n    }\n  "], ["\n    query contactGql($id: ID!, $domain: String!) {\n      contactAppById(domain: $domain, id: $id) {\n        business_number\n        mobile_number\n        first_name\n        private_number\n        fax\n        website\n        address\n        logical20\n        name\n        id\n        postal_code\n        city\n        po_box\n        geocode_address {\n          lat\n          lon\n        }\n      }\n    }\n  "])));
            return _this;
        }
        ContactRest.decorators = [
            { type: i0.Injectable, args: [{
                        providedIn: 'root'
                    },] }
        ];
        /** @nocollapse */ ContactRest.ngInjectableDef = i0.defineInjectable({ factory: function ContactRest_Factory() { return new ContactRest(i0.inject(i1$2.Apollo)); }, token: ContactRest, providedIn: "root" });
        return ContactRest;
    }(i1$2.Query));
    ...
    var ContactsComponent = /** @class */ (function () {
        function ContactsComponent(storageService, contactsHelper, contactListGQL, router$$1, cd, groupingContact, keyboardHelper) {
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                this.contactsGqlQuery.valueChanges
                                    .pipe(operators.pluck('data', 'contactApps'), operators.takeUntil(this.subject), 
                                // @ts-ignore
                                operators.map(( /**
                                 * @param {?} contactApps
                                 * @return {?}
                                 */function (contactApps) { return _this.countContacts(contactApps); })))
                                    .subscribe(( /**
                             * @param {?} contacts
                             * @return {?}
                             */function (contacts) {
    ...
    var ContactDetailComponent = /** @class */ (function () {
        function ContactDetailComponent(contactRest, contactHelper, appProjectsService) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                             ...
                             */function (_a) {
                                    ...
                                    _this.totalCount = data.projectApps.pageInfo.totalCount;
                                }));
                                return [2 /*return*/];
                        }
                    });
            ...
            function () {
                this.appProjectsQuery.fetchMore({
                     ...
                     */function (prev, _a) {
                        ...
                        return update(prev, {
                            projectApps: {
                                items: { $push: fetchMoreResult.projectApps.items },
                                pageInfo: { $merge: fetchMoreResult.projectApps.pageInfo }
                            }
                        });
                    })
                });
         ...
         * @return {?}
         */
        ContactDetailComponent.prototype.initActiveContact = /**
         * @private
         * @return {?}
         */
            function () {
                // this.contactHelper.activeContact
                //   // .pipe(take(1))
                //   .pipe(takeUntil(this.subject))
                //   .subscribe(contact => {
                //     this.getContact(contact.id, this.activeDomainName);
                //   });
            };
        /**
         * @private
         ...
         * @return {?}
         */
        ContactDetailComponent.prototype.getContact = /**
         * @private
         * @param {?} id
         * @param {?} domain
         * @return {?}
         */
            function (id, domain) {
                // this.activeContact$ = this.contactRest
                //   .watch({id, domain})
                //   .valueChanges
                //   .pipe(pluck('data', 'contactAppById'));
                // this.contactRest
                //   .watch({ id, domain })
                //   .valueChanges.pipe(pluck('data', 'contactAppById'))
                //   .subscribe(contact => {
    ...
    var ScrollerComponent = /** @class */ (function () {
        function ScrollerComponent(contactHelper) {
            this.contactHelper = contactHelper;
         ...
         */
            function () {
                 ...
                 * @return {?}
                 */function (index) {
                        if (_this.contacts && _this.contacts[index] && _this.contacts[index].text) {
    ...
    function createApollo() {
        ...
        return {
            cache: new apolloCacheInmemory.InMemoryCache({
                ...
                dataIdFromObject: apolloCacheInmemory.defaultDataIdFromObject,
                addTypename: true
            }),
