(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ionic-native/in-app-browser/ngx'), require('@ionic-native/in-app-browser/ngx/index'), require('immutability-helper'), require('@sorba-app/sorba-ui-components'), require('@ionic/angular'), require('@angular/common'), require('@agm/core'), require('@angular/platform-browser'), require('@angular/router'), require('@angular/forms'), require('graphql-tag'), require('@ionic-native/document-viewer/ngx'), require('@ionic-native/file/ngx'), require('@ionic-native/file-opener/ngx'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/scrolling'), require('@angular/core'), require('apollo-angular'), require('apollo-cache-inmemory')) :
    typeof define === 'function' && define.amd ? define('contacts', ['exports', '@ionic-native/in-app-browser/ngx', '@ionic-native/in-app-browser/ngx/index', 'immutability-helper', '@sorba-app/sorba-ui-components', '@ionic/angular', '@angular/common', '@agm/core', '@angular/platform-browser', '@angular/router', '@angular/forms', 'graphql-tag', '@ionic-native/document-viewer/ngx', '@ionic-native/file/ngx', '@ionic-native/file-opener/ngx', 'rxjs', 'rxjs/operators', '@angular/cdk/scrolling', '@angular/core', 'apollo-angular', 'apollo-cache-inmemory'], factory) :
    (factory((global.contacts = {}),global.ngx,global.i1,global.update,global.sorbaUiComponents,global.i1$1,global.ng.common,global.core,global.ng.platformBrowser,global.ng.router,global.ng.forms,global.gql,global.ngx$1,global.ngx$2,global.ngx$3,global.rxjs,global.rxjs.operators,global.ng.cdk.scrolling,global.ng.core,global.i1$2,global.apolloCacheInmemory));
}(this, (function (exports,ngx,i1,update,sorbaUiComponents,i1$1,common,core,platformBrowser,router,forms,gql,ngx$1,ngx$2,ngx$3,rxjs,operators,scrolling,i0,i1$2,apolloCacheInmemory) { 'use strict';
    ...
    var ScrollerComponent = /** @class */ (function () {
        ...
        ScrollerComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        styles: [".loader{height:50px}.scroller-wrapper{position:relative}@media (max-width:767px){.scroller{height:calc(100vh - 220px)}}"]
                    }] }
        ];
        /** @nocollapse */
